    ...
    <PageContainer>
      ...
      <Section>
        ...
        <FilterContainer>
          ...
          <FilterButton
            $active={anneeSelectionnee === "2019"}
            onClick={() => setAnneeSelectionnee("2019")}
          >
            <CalendarOutlined /> 2019
          </FilterButton>
          <FilterButton
            $active={anneeSelectionnee === "2018"}
            onClick={() => setAnneeSelectionnee("2018")}
          >
            <CalendarOutlined /> 2018
          </FilterButton>
          <FilterButton
            $active={anneeSelectionnee === "2017"}
            onClick={() => setAnneeSelectionnee("2017")}
          >
            <CalendarOutlined /> 2017
          </FilterButton>
          <FilterButton
            $active={anneeSelectionnee === "2016"}
            onClick={() => setAnneeSelectionnee("2016")}
          >
            <CalendarOutlined /> 2016
          </FilterButton>
          <FilterButton
            $active={anneeSelectionnee === "2015"}
            onClick={() => setAnneeSelectionnee("2015")}
          >
            <CalendarOutlined /> 2015
          </FilterButton>
        </FilterContainer>
              ...
              <Table
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    key: "taux_sos",
                    render: (_, record) =>
                      formatPercent(record.statistiques.taux_actes_sos.moyenne),
                    sorter: (a, b) =>
