...
const CustomLegend = () => {
  return (
    <div style={{ color: '#eee', fontSize: 14, lineHeight: 1.6, marginLeft: 20, minWidth: 200 }}>
      ...
      <div><span style={{ color: '#4834d4', borderBottom: '2px dashed #4834d4', display: 'inline-block', width: 12 }}></span> Zone A garçons dose 1</div>
      <div><span style={{ color: '#38ada9', borderBottom: '2px dashed #38ada9', display: 'inline-block', width: 12 }}></span> Zone B garçons dose 1</div>
      <div><span style={{ color: '#e58e26', borderBottom: '2px dashed #e58e26', display: 'inline-block', width: 12 }}></span> Zone C garçons dose 1</div>
    </div>
  );
};

export const CustomLineChart = ({dataHpvByZone}) => {
	return (<div style={{ backgroundColor: '#121c21', padding: 20, display: 'flex', alignItems: 'center' }}>
